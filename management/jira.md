...
Source: [official docs](https://developer.atlassian.com/cloud/)
...
* [Administration](#administration)
    ...
    * [Example Scheme Workflow](#example-scheme-workflow)
* [Icebox](#icebox)
* [Addons](#Addons)
...
![An Example Scrum Workflow](./example_workflow.png)

Credits: [Kosh Sarkar](https://www.udemy.com/the-complete-guide-to-jira-with-real-world-examples/)

## Example Scheme Workflow

__Issue Type Creation__

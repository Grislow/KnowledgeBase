...
Finally lets look at a nice file structure for a python program take from [dev.to](https://dev.to/codemouse92/dead-simple-python-project-structure-and-imports-38c6)
